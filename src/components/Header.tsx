...
const Header: React.FC = () => (
  <header
    id="header"
    className="fixed top-0 w-full z-50 transition-all duration-500 p-5 bg-tansparent bg-opacity-90"
  >
    <div className="container mx-auto flex items-center justify-between">
      ...
      <nav id="navbar" className="navbar">
        <ul className="flex space-x-6">
          ...
          <li>
            <Link className="hover:text-gray-400" to="/projects">
              Make Scent
            </Link>
          </li>
          <li>
        ...
        <i className="bi bi-list text-3xl cursor-pointer lg:hidden"></i>
      </nav>
    </div>
  </header>
)
